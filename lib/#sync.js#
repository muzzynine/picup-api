...
var computeTraversal = function(revision){
    ...
    try {
        ...
        log.error("Sync#computeTraversal/compute error", {err:err});
 ...
 * @returns {*}
 */
var generateNodeInfo = function(deltaArray, uid, gid, revision){
   ...
   for(var i in deltaArray){
       ...
       if(nodeInfo.presence === PRESENCE_ADD) {
           /*
...
exports.generateNodeInfo = generateNodeInfo;
...
exports.computeTraversal = computeTraversal;
exports.PRESENCE_ADD = PRESENCE_ADD;
exports.PRESENCE_DELETE = PRESENCE_DELETE;
exports.PRESENCE_REPLACE = PRESENCE_REPLACE;
